...
const ScrollRestorationManager = ({ children }: { children: React.ReactNode }) => {
  ...
  const scrollToHashElement = (hash: string) => {
    ...
    const attemptScroll = (retryCount = 0, maxRetries = 10) => {
      ...
      if (element) {
        ...
        // Use both scrollIntoView and manual scrollTo for better compatibility
        try {
          ...
          // // Also use scrollIntoView as a backup
          // setTimeout(() => {
