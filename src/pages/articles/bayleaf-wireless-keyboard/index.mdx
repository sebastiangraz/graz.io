---
title: Bayleaf Wireless Keyboard
---

# Summary

- Wireless 60% split (6x5 per side)
- PG1316S switches
- MFJ printed custom keycaps in gray nylon
- CNC machined 7075 aluminum enclosure, media blasted, clear anodized
- Custom PCB with white solder mask
- Dimensions: W139 L93 H5-3 (mm)
- Weight: 91g / side
- Software: ZMK flashed with Studio compatibility
- Timeline ~3 months
- Total cost per set: ~$313
  - 1 pair of enclosures $187
  - 1 pair of PCB $28
  - 60x Keycaps $58
  - Components: ~$40

This is an array `[1, 2, 3]{:js}` of numbers 1 through 3.
The name of the function is `getStringLength{:js}`.
...
code > [data-line]::before {
  ...
  content: counter(line); # [!code highlight]
  /* Other styling */
  display: inline-block;
}

code[data-line-numbers-max-digits='2'] > [data-line]::before { # [!code highlight]
  width: 2rem;
}
...
<aside>We do not just present theories or generic advice–we conduct a thorough investigation to.</aside>
