...
<ImageRow>
  <Img src="figleaf-render-stacked-bg-dark.png" alt="Figleaf" />
</ImageRow>

# Hardware prototypes

Receiving real parts is equally exciting as it is terrifying. It never gets old going from screen to the real thing. But not being able to <mark>Ctrl-Z</mark> machined hardware is scary. Luckily after some quick testing, all the parts fit together as I intended.
...
Hope you enjoyed this early introduction to Figleaf. Next post we'll get into the nitty gritty of building this thing. And deep-dive into design decisions, compromises, constraints, failures, and compare it to our previous iteration, <mark><Link to="/articles/bayleaf-wireless-keyboard">Bayleaf</Link></mark>.
