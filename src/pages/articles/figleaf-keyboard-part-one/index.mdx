...
Hope you enjoyed this early introduction to Figleaf. Next post we'll get into the nitty gritty of building this thing. And deep-dive into design decisions, compromises, constraints, and compare it to our previous iteration, <mark><Link to="/articles/bayleaf-wireless-keyboard">Bayleaf</Link></mark>.
