...
export const images = {
  canon1: {
    url: "./assets/canon-1.png",
    webP: "./assets/canon-1.webp",
    width: 2266,
    height: 2748,
    alt: "canon",
  },
  canon2: {
    url: "./assets/canon-2.png",
    webP: "./assets/canon-2.webp",
    width: 2266,
    height: 2787,
    alt: "canon",
  },
  canon3: {
    url: "./assets/canon-3.png",
    webP: "./assets/canon-3.webp",
    width: 2266,
    height: 3912,
    alt: "canon",
  },
  layout: {
    url: "./assets/layout.jpg",
    webP: "./assets/layout.webp",
    width: 2336,
    height: 2049,
    alt: "layout",
  },
  motion: {
    url: "./assets/motion.jpg",
    webP: "./assets/motion.webp",
    width: 2336,
    height: 2049,
    alt: "motion",
  },
  producttiles: {
    url: "./assets/producttiles.jpg",
    webP: "./assets/producttiles.webp",
    width: 2336,
    height: 1957,
    alt: "motion",
  },
  accordions: {
    url: "./assets/accordions.jpg",
    webP: "./assets/accordions.webp",
    width: 2336,
    height: 2140,
    alt: "motion",
  },
  width: {
    url: "./assets/width.jpg",
    webP: "./assets/width.webp",
    width: 2336,
    height: 1957,
    alt: "motion",
  },
  homepage1: {
    url: "./assets/homepage1.jpg",
    webP: "./assets/homepage1.webp",
    width: 2336,
    height: 5353,
    alt: "motion",
  },
